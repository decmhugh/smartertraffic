...
def distance_of_line(x):
    distance.VincentyDistance.ELLIPSOID = 'WGS-84' 
    l1=loads(x)
    d1 = distance.distance
    c1, c2 = l1.xy
    x = OSIRISH36toWGS84(c1[0], c2[0])
    y = OSIRISH36toWGS84(c1[1], c2[1])
    dist1 = d1(x, y)
    return dist1.kilometers/1000

def touching_of_line(line,line2):
    line_wkt=loads(line)
    line_wkt2=loads(line2)
    return line_wkt.touches(line_wkt2)
